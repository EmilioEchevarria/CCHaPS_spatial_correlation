...
mpifort -c $NC_INC -O3 -ip -g -traceback -assume byterecl spatial_correlation_dir.f90
mpifort -lcurl -o spatial_correlation_dir spatial_correlation_dir.o $NC_LIB

rm spatial_correlation_dir.o
